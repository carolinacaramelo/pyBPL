...
function [list_perror, average_error] = run_classification_perturbing 

    classdir = './model_refits'; %don't forget we have to change this folder to the model folder - the refitting will run in the matlab 
    ...
    for r=1:nrun
        ...
        list_perror(r) = perror(r);
        fprintf(1,' run %d (error %s%%)\n',r,num2str(perror(r),3));
    end
    average_error = mean(perror);
